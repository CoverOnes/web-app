...
// ════════════════════════════════════════════════════════════════════════════
// SVG network graph — center node = you, spokes = REAL accepted connections.
// Radial layout: cx = 380 + R cos θ, cy = 160 + R sin θ, θ = 2π·i/n. No d3.
// Mobile caps at 6 nodes (passed via `cap`). Empty (n=0) → center node + 尚無連結.
// ════════════════════════════════════════════════════════════════════════════
...
function NetworkGraph({ centerInitial, connections, cap }: NetworkGraphProps) {
