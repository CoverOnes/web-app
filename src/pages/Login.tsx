      ...
      <section style={{ padding: '36px 56px 36px 0', display: 'flex', flexDirection: 'column', alignItems: 'stretch' }}>
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{
            ...
            <p style={{ fontSize: 13.5, color: 'var(--color-main-text-dim)', margin: '0 0 26px 0' }}>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div style={{ marginBottom: 14 }}>
                <label htmlFor="login-email" style={{ display: 'block', fontSize: 12, fontWeight: 500, color: 'var(--color-main-text-dim)', marginBottom: 7 }}>
                  Email
                </label>
                <div style={{
                  ...
                  border: `1px solid ${emailFocus ? 'var(--color-indigo)' : 'var(--color-main-border)'}`,
                  borderRadius: 11,
                  ...
                  <input
                    ...
                    style={{ flex: 1, fontSize: 14, background: 'transparent', border: 'none', outline: 'none', color: 'var(--color-main-text)' }}
                  />
                </div>
              </div>
              ...
              <div style={{ marginBottom: 22 }}>
                <label htmlFor="login-password" style={{ display: 'block', fontSize: 12, fontWeight: 500, color: 'var(--color-main-text-dim)', marginBottom: 7 }}>
                  Password
                </label>
                <div style={{
                  display: 'flex', alignItems: 'center', gap: 10,
